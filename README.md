...
![image](https://github.com/user-attachments/assets/212906d9-b95c-4176-b65c-04db98484d9f)
...
usecase "UC 2.1 Выбор города" as UC3
usecase "UC 2.2 Выбор мойки" as UC4
usecase "UC 2.3 Выбор услуги" as UC5
usecase "UC 2.4 Выбор даты и времени" as UC6
usecase "UC 2 Запись на услугу" as UC7
usecase "UC 2.5 Выбор способа оплаты" as UC8
usecase "UC 2.6 Оплатить услугу" as UC9
usecase "UC 3 Отменить запись" as UC10
...
![image](https://github.com/user-attachments/assets/e0930ea2-db0f-4607-aa73-b848002f1e3d)
...
Пользователь -> Система: Просмотр информации об автомобиле
Система -> База данных:Запрос данных об автомобиле
База данных->База данных:Чтение данных из БД
alt Автомобиль найден
База данных --> Система:Успешная операция 
Система--> Пользователь: Данные об автомобиле
else Автомобиль не найден
База данных --> Система: Сообщение об ошибке

Система --> Пользователь:Предложение проверить данные или добавить новый автомобиль
end
...
Система -> База данных: Запрос доступных услуг
База данных->База данных:Чтение данных из БД
База данных --> Система: Доступные услуги
Система --> Пользователь: Показать список услуг данной автомойки

Пользователь -> Система: Выбрать услуги
Система -> База данных: Запрос доступных слотов дата/время
База данных->База данных:Чтение данных из БД
База данных --> Система: Доступные слоты
Система --> Пользователь: "Календарь" с доступными слотами


Пользователь -> Система:Подтвердить выбранную запись
